      ...
      <div class="navbar navbar-dark bg-dark shadow-sm">
        <div class="container d-flex justify-content-between">
          ...
          <?php
            ...
            ?>
                <span class="login"><a href="login/signInForm.php">로그인</a></span>
                <span class="login"><a href="signUp/signUpForm.php">회원가입</a></span>
                
            <?php
                } else {
            ?> 
                <span class="login"><a href="#">방가워요</a></span>
                <span class="login"><a href="signUp/logout.php">로그아웃 </a></span>
